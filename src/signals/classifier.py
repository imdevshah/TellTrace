...
def analyse(image_path, features, emotion=None):
    ...
    prompt = f""" I am an expert body language analyst with deep knowledge
of nonverbal communication research.

I will be given an image of a person and precise postural measurements
extracted from their pose keypoints.

My job is to interpret what these signals mean TOGETHER — not in isolation.
...
0.0 and 1.0 (e.g. 0.75), NEVER a percentage like 75."""
    ...
    try:
        ...
        # actually returns — my previous version
